...
func init() {
	...
	webhookNamespace = os.Getenv("WORKSPACE_NAMESPACE")
	// webhookNamespace = "tnfnwn123-gmail-com-che-8dyyy9"
}
...
func main() {
	...
	flag.StringVar(&sidecarConfigFile, "sidecar-config-file", "/projects/kube-sidecar-injector/sidecarconfig.yaml", "Sidecar injector configuration file.")
